...
const mockData = {
    presentationDetail: {
        ...
        data: {
            ...
            slideCount: 4,
            slides: [
                { id: 24, admin_key: "SsIibypcSLJGwVOgO7eCf", type: "multiple_choice" },
                { id: 25, admin_key: "Kg3cwtJP-tp2R54apMfH8", type: "multiple_choice" },
                { id: 26, admin_key: "-B9XUboB9t8ycw0Og35oo", type: "multiple_choice" },
                { id: 35, admin_key: "Hj_7YOUTHGRJBmrCYYJ7O", type: "multiple_choice" },
            ],
    ...
    slideResult: {
        ...
        data: {
            ...
            results: [
                ...
                { id: "1", label: "Lựa chọn 2", score: [0] },
                { id: "2", label: "Lựa chọn 3", score: [0] },
            ],
        },
